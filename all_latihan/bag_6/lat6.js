...
function linearSearch(producsDetail, id) {
  for (let i = 0; i < producsDetail.length; i++) {
    if (producsDetail[i].id === id) {
      return producsDetail[i];
    }
  }
  return undefined; 

}
console.log(linearSearch(producsDetail, 3));


console.log(linearSearch(producsDetail, 999));
