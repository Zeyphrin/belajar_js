...
const numberArray = [5, 3, 8, 1];
const sortedNumbers = bubbleSort(numberArray);

// console.log(numberArray);       
// console.log(sortedNumbers); 

function sortProducts(producsDetail, sortBy) {
  const arr = [...producsDetail];
...
console.log("Sort by Price (Asc):", sortProducts(producsDetail, "price-asc"));
console.log("Sort by Rating (Desc):", sortProducts(producsDetail, "rating"));
console.log("Sort by Title (A-Z):", sortProducts(producsDetail, "title"));
