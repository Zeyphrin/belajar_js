...
requestQueue.enqueue("Request #1: Ambil Data Produk");
requestQueue.enqueue("Request #2: Hitung Total Harga");
requestQueue.enqueue("Request #3: Proses Pembayaran");

console.log("Antrean saat ini:", requestQueue.items);
console.log("Request yang akan diproses selanjutnya:", requestQueue.peek());

console.log("\nMemulai proses antrean:");
while (!requestQueue.isEmpty()) {
  const diproses = requestQueue.dequeue();
  console.log(`Menjalankan: ${diproses}`);
}

console.log("\nSemua request selesai diproses. Antrean kosong:", requestQueue.isEmpty());