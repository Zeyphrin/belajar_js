...
const uniqueCategories = [...new Set(productsDetail.map(p => p.category))];
console.log("uniqueCategories : ", uniqueCategories);


const uniqueBrands = [...new Set(productsDetail.map(p => p.brand).filter(brand => brand !== undefined))];
console.log("uniqueBrands:", uniqueBrands);

const uniqueTags = [...new Set(productsDetail.flatMap(p => p.tags))];
